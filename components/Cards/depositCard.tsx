            ...
            <div className='relative mt-10 h-auto w-full md:w-[60vw] p-10 bg-gray-400 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40 border border-gray-100'>
                ...
                <div className='flex-col lg:flex-row flex items-center justify-center lg:divide-x-2 '>
                    <div className='w-full'>
                        <h2 className="text-xl md:text-3xl font-bold text-gray-300 hover:text-white mt-4">DEPOSIT</h2>
                                ...
                                <div className="flex-col md:flex-row flex items-center py-2">
                                    <div className='flex-row flex md:flex-col m-2'>
                                        <div className='border-b-2 border-white w-full md:w-24'>
                                            <input className=" appearance-none bg-transparent border-none w-full text-gray-100 mr-3 py-1 px-2 leading-tight focus:outline-none placeholder:text-gray-100 placeholder:text-base " type="number" placeholder="USDT" aria-label="Enter Amount" />
                                        </div>
                                        <button className="mt-1 sm:mt-2 flex-shrink-0 text-base sm:text-xl font-bold text-white py-1 px-2 rounded" type="button">
                                            APPROVE
                                        </button>
                                    </div>
                                    <div className='flex-row flex md:flex-col m-2'>
                    ...
                    <h2 className="text-xl md:text-3xl font-bold text-gray-300 hover:text-white mt-4">Wallet Balance</h2>
                        <div className='mt-4 p-4'>
                            <p className='text-lg text-white '>USDC : $</p>
                            <p className='text-lg text-white '>USDC : $</p>
                            <p className='text-lg text-white '>USDC : $</p>
